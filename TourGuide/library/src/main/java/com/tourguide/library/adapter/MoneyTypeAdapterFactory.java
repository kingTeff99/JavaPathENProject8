...
public class MoneyTypeAdapterFactory implements TypeAdapterFactory{
	...
	/**
     * This is the Default implementation. Here, the implementation 
     * of the {@code javax.money} defined in the classpath
     * will be used.
     */
     ...
     */
    public MoneyTypeAdapterFactory(final MonetaryAmountFactory
    		<? extends MonetaryAmount> monetaryFactory) {
